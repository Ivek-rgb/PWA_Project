 ...
 * 
 */
// this here is to ensure that scraping is not stopped by anything timeout related 
// keep this here until i find a better way or just update mods to scrape
...
class HtmlWeb {
	...
	private function load_curl($url)
	{
		...
		/**
		 * Modification: Bench
		 * just sets the stuff to not close on timeout so i can scrape much better
		 */
		...
		// There is no guarantee this request will be fulfilledF
		$header = array(
